...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "focus:bg-primary/15 focus:text-primary data-[state=open]:bg-primary/15",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-[100] min-w-[10rem] overflow-hidden rounded-xl border border-white/10 glass-panel p-1 shadow-glass",
...
>(({ className, inset, variant = "default", ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-primary/15 focus:text-primary data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      variant === "destructive" && "text-urgency-critical focus:bg-urgency-critical/15 focus:text-urgency-critical",
      inset && "pl-8",
      className
    )}
    {...props}
